...
public class SceneController : MonoBehaviour
{
    ...
    public string initialStartingPositionName = "TypingAtLaptop";
    ...
    {
        // Initialices all data from LoadSave
        ...
        if(!gs.gameStates[(int)GameStates.Intro1Played]) //First Load!!
        {
            //Debug.Log("Primera " + LocalizableData.instance.languageText[1]);
            gs.gameStrings[(int)GameStrings.StartingScene]=defaultInitialScene;
            gs.gameValues[(int)GameValues.StartingTextIndex] = 1;
        }
    ...
    public delegate void MiddleFade();
    // This is the coroutine where the 'building blocks' of the script are put together.
    public IEnumerator FadeAndCallBack(MiddleFade callBack)
    {
        yield return StartCoroutine(Fade(1f));
